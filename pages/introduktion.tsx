...
export default function Introduktion() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      <h1 className="text-3xl font-bold mb-4">Virtuell introduktion</h1>
      <p className="mb-4">
        Välkommen till Konsthall Tornedalen! Här kan du bekanta dig med vår konsthall och närområdet.
      </p>

      <h2 className="text-xl font-semibold mt-6 mb-2">🎥 Digital rundtur</h2>
